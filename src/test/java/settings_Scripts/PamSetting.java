...
public class PamSetting {
	...
	public void launchBrowser() throws InterruptedException {
		// Extent Reports
		reports = new ExtentReports(EnvironmentVariables.extendReportsPath("PAM Setting"),
				NetworkMode.OFFLINE);
		logger = reports.startTest("PAM Setting");
	}

	@Test(dataProvider = "TestData")
	public void ViewCoachingLog(String flag, String browser, String level, String userName, String password, String EID,
			String Text, String Month, String Status,String FullName,String Supervisor) throws Exception {
		// Verify browser
		if (flag.equalsIgnoreCase("Y")) {
			...
			Thread.sleep(1500);
			setting.pamSetting(driver, browser, EID, Text, Month, Status,FullName,Supervisor, logger);
