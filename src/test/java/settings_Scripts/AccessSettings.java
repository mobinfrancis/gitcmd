...
public class AccessSettings {
	...
	ExtentTest logger;
	SettingsMethods setting = new SettingsMethods();

	@BeforeClass
	public void launchBrowser() throws InterruptedException {
		// Extent Reports
		reports = new ExtentReports(EnvironmentVariables.extendReportsPath("Access Settings"),
				NetworkMode.OFFLINE);
		logger = reports.startTest("Access Settings");
	}

	@Test(dataProvider = "TestData")
	public void ViewCoachingLog(String flag, String browser, String level, String userName, String password, String EID,
			String AccessLevel, String UpdateEID, String Status, String EditAccessLevel) throws Exception {
		// Verify browser
					...
					"=========================================== Start of Scenario ==============================================");
		{
			...
			setting.accessSettings(driver, browser, level, EID, AccessLevel, UpdateEID, Status, EditAccessLevel,
					logger);
	...
	public Object[][] getValueFromExcel(ITestContext context) {
		String sheetName = "AccessSetting";
