...
public class Dashboard {
	...
	public void launchBrowser() throws InterruptedException {
		...
		reports = new ExtentReports(EnvironmentVariables.extendReportsPath("Extract Prod and Quality Reports"),
				NetworkMode.OFFLINE);
		logger = reports.startTest("Dashboard");
	}

	@Test(dataProvider = "TestData")
	public void dashboard(String flag, String browser, String level, String userName, String password, String month,
			String year, String tower, String search) throws Exception {
		// Verify browser
		if (flag.equalsIgnoreCase("Y")) {
			...
			// Dashboard
			dashboardMethods.dashboard(driver, logger, level, month, year, tower, search);
